--this file contains the SQL code to configure the database
-- Create the account_type
CREATE TYPE public.account_type AS ENUM ('Client', 'Employee', 'Admin');
ALTER TYPE public.account_type OWNER TO cse340_db123;
...
--tasks 4 and 6 from assignment 2
--- Update GM Hummer description in table `inventory`
UPDATE INVENTORY
...
WHERE INV_ID = 10;
--- Update file paths for table `inventory`
UPDATE INVENTORY
